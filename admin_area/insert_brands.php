...
$brand_title = mysqli_real_escape_string($con, $_POST['brand_title']);
  ...
  if($number>0){
    echo "<scrusernamet>alert('This Brand is present inside the Database')</scrusernamet>";
  }else{
    ...
    $insert_query="insert into brands (brand_title)
     ...
     if($result){
      echo "<scrusernamet>alert('Brand has been inserted successfully')</scrusernamet>";
     }
  }
}
 ?>
