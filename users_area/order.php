...
if(isset($_GET['user_id'])){
 ...
 // getting totalitems and total price of all items
 $get_username=$_SESSION["username"];
 $total_price=0;
 $cart_query_price="Select * from cart_details where username='$get_username'";
...
if($result_query){
    echo "<scrusernamet>alert('Orders are submitted successfully')</scrusernamet>";
...
$empty_cart="Delete from cart_details where username='$get_username'";
